...
export function CrossEntropyPlayground() {
  ...
  return (
    <WidgetFrame
      ...
      note="Кривая ниже показывает, как loss зависит от p(правильный): около единицы он почти ноль, а при уверенной ошибке (p → 0) уходит в бесконечность. Модель сильнее всего наказывают за уверенные промахи."
    >
