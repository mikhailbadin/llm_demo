  ...
  return (
    <>
      ...
      <p>
        ...
        каждый токен по отдельности. Между ними — нормализация и сложение.
      </p>
      ...
      <h2>Стек целиком</h2>
      <Callout kind="try">
        В сцене ниже — весь путь: токены, эмбеддинги, N блоков, выходной слой. Нажмите на блок, чтобы раскрыть его. Ползунок в панели меняет глубину. Экскурсия
      ...
      <p>
        Все матрицы во всех блоках, плюс таблица эмбеддингов, плюс выходной слой — это и есть <Term id="parameters">параметры</Term> модели. Их число задаётся
        всего несколькими размерами: длиной вектора <M tex="d" />, числом блоков <M tex="L" /> и размером словаря <M tex="|V|" />.
      </p>
      <Formula tex={String.raw`N \approx 12 \cdot L \cdot d^2 + |V| \cdot d`} caption={<>На один блок: 4d² во внимании (матрицы Q, K, V, O) и 8d² в MLP (расширение до 4d и обратно). Плюс таблица эмбеддингов |V|·d.</>} />
      <ParameterCalculator />
