...
export const ATTENTION_TOUR: TourStep[] = [
  ...
  },
  {
    ...
    highlight: ['edge:1:7-0', 'bar:0', 't0', 't7'],
    params: { example: 'cat', head: 1, causal: false, allHeads: false },
    select: 't7',
  },
  {
  ...
  },
  {
    ...
    text: 'При генерации токен не может видеть будущее — ведь его ещё нет. Включили причинную маску и выбрали «потому»: без маски больше половины его внимания уходило вперёд, на «что». Теперь дуги к словам справа исчезли, а веса перераспределились между теми, что слева.',
    camera: { position: [1.5, 4.5, 9.5], target: [1.35, 0.6, 0] },
    highlight: [],
