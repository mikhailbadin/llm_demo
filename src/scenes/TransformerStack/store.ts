...
export const TRANSFORMER_TOUR: TourStep[] = [
  ...
  {
    id: 'repeat',
    title: 'Блоки повторяются L раз',
    text: 'Блоки одинаковы по устройству, но у каждого свои параметры. Здесь мы поставили 12 блоков, как в GPT-2 small; у GPT-3 их 96. Ползунком в панели можно менять число блоков: глубина растёт, а принцип остаётся тем же.',
    camera: { position: [11.6, 11.3, 21.7], target: [0, 8, 0] },
    highlight: [],
    params: { layers: 12, exploded: -1 },
  },
  {
    id: 'output',
